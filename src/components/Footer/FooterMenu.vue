<template lang="">
  <div
    class="bg-white bg-no-repeat custom-dropshadow footer-bg dark:bg-slate-800 flex justify-around items-center backdrop-filter backdrop-blur-[40px] fixed left-0 w-full z-[9999] bottom-0 px-4 pt-[12px] pb-[calc(12px+env(safe-area-inset-bottom))]"
  >
    ...
    <router-link
      v-slot="{ isActive }"
      to="#"
      class="relative bg-white bg-no-repeat backdrop-filter backdrop-blur-[40px] rounded-full footer-bg dark:bg-slate-800 h-[60px] w-[60px] sm:h-[65px] sm:w-[65px] z-[-1] -mt-[36px] sm:-mt-[40px] flex justify-center items-center"
    >
      <div
